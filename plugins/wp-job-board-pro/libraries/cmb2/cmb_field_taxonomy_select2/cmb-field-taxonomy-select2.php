...
class PW_CMB2_Field_Taxonomy_Select2 {
	 ...
	 */
	public function get_pw_taxonomy_options( $field_escaped_value, $field_type_object ) {
    ...
    public function get_terms($taxonomy, $query_args = array()) {
        ...
        $defaults = array(
            ...
            'order' => 'ASC',
            'hierarchical' => 1,
            'lang' => apply_filters( 'wp-job-board-pro-current-lang', null )
	    );
	    $args = wp_parse_args( $query_args, $defaults );

	    $terms_hash = 'wjbp_cats_' . md5( wp_json_encode( $args ) . WP_Job_Board_Pro_Cache_Helper::get_transient_version('wjbp_get_' . $taxonomy) );
