    ...
    final class Superio_Elementor_Extensions {
        ...
        public function elementor_widgets() {
            ...
            if ( superio_is_wp_job_board_pro_activated() ) {
                ...
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/jobs_vertical_carousel' );
                ...
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/user_info2' );
                ...
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/register_form_tabs' );
                ...
                if ( defined('WP_JOB_BOARD_PRO_PLUGIN_VERSION') && version_compare(WP_JOB_BOARD_PRO_PLUGIN_VERSION, '1.2.17', '>=') ) {
                    get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/currencies_switcher' );
                }
            }
            ...
            if ( superio_is_wp_job_board_pro_wc_paid_listings_activated() && superio_is_woocommerce_activated() ) {
                ...
                get_template_part( 'inc/vendors/elementor/wc-paid-listings-widgets/package' );
        ...
        public function additional_animations($animations = array()) {
            $additional_animations = array(
                'ApusTheme' => [
                    'scale' => esc_html__('Scale', 'superio'),
                    'fancy' => esc_html__('Fancy', 'superio'),
                    'slide-up' => esc_html__('Slide Up', 'superio'),
                    'slide-left' => esc_html__('Slide Left', 'superio'),
                    'slide-right' => esc_html__('Slide Right', 'superio'),
                    'slide-down' => esc_html__('Slide Down', 'superio'),
                ],
            );
