...
class Superio_Search extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'superio'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'superio' ), )
        );
...
register_widget('Superio_Search');
